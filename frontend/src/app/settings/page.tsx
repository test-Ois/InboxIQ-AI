    ...
    <SidebarLayout>
      <div className="p-6 md:p-8 max-w-4xl mx-auto space-y-8 animate-fade-in-up">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-400">Configure your email intelligence integration preferences.</p>
        </div>
        ...
        <div className="glass-panel p-6 rounded-2xl border border-zinc-800 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="mt-1 px-4 py-3 rounded-xl border border-zinc-800 bg-zinc-900/35 text-sm text-zinc-300">
        ...
        <div className="glass-panel p-6 rounded-2xl border border-zinc-800 space-y-4">
          ...
          <div className="flex items-start gap-3 p-4 rounded-xl border border-indigo-500/20 bg-indigo-500/5 text-xs text-indigo-300">
        ...
        <div className="glass-panel rounded-2xl overflow-hidden border border-zinc-800">
          <div className="px-6 py-5 border-b border-zinc-900 bg-zinc-900/10 flex items-center justify-between">
            ...
            <span className="text-xs text-indigo-400 font-semibold bg-indigo-500/10 px-2.5 py-1 rounded-full border border-indigo-500/20">Phase 2+ Previews</span>
          </div>
          ...
          <div className="p-6 divide-y divide-zinc-900 space-y-6">
            ...
            <div className="flex items-center justify-between pt-0 pb-6">
              ...
              <button 
                ...
                className={`w-11 h-6 flex items-center rounded-full p-1 cursor-pointer transition-colors duration-250 ${aiEnabled ? 'bg-indigo-600' : 'bg-zinc-800'}`}
              >
            ...
            <div className="flex items-center justify-between py-6">
              ...
              <button 
                ...
                className={`w-11 h-6 flex items-center rounded-full p-1 cursor-pointer transition-colors duration-250 ${taskEnabled ? 'bg-indigo-600' : 'bg-zinc-800'}`}
              >
            ...
            <div className="flex items-center justify-between py-6">
              ...
              <button 
                ...
                className={`w-11 h-6 flex items-center rounded-full p-1 cursor-pointer transition-colors duration-250 ${fraudEnabled ? 'bg-indigo-600' : 'bg-zinc-800'}`}
              >
